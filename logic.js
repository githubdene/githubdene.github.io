var searchResultFormat = '<tr><td><a href="$link" target="_blank">$target</a></td><td align="center">$title</td><td>$tag2</td><td>$tag3</tr>';
var totalLimit = 750;
...
var controls = {
    ...
    doSearch: function(match, dataset) {
        ...
        dataset.forEach(e => {
            ...
            if ((e.title + e.target + e.tag2 + e.tag3).toLowerCase().match(regex)) results.push(e);
        });
        return results;
    },
